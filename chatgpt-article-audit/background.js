const PROMPT =
  "下記の記事の誤り・怪しい箇所を列挙して下さい。次に、評価できる点も挙げて、最後に「どの程度正しい、もしくは信憑性のある記事か」と「どの程度有用性のある記事か」を結論として述べて下さい。どの程度というのは 0～100 パーセントの表記も教えて下さい。(80～85%など)誤字脱字など、誤り・怪しい箇所・信憑性に直接関係しない指摘は控えて下さい。";
